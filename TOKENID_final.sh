...
status_row() {
    ...
    case $status in
        ok)        color="\e[1;32mOK\e[0m" ;;
        instalado) color="\e[1;36mINSTALADO\e[0m" ;;
        error)     color="\e[1;31mERROR\e[0m" ;;
        fallo)     color="\e[1;31mFALLO\e[0m" ;;
        creado)    color="\e[1;33mCREADO\e[0m" ;;
        *)         color="\e[1;37m…\e[0m" ;;
    esac

    printf "  \e[1;37m• %-20s [ %s ]\e[0m\n" "$text" "$color"
}
...
echo -e "\n\e[1;37mINICIANDO INSTALACIÓN...\e[0m"
sleep 1

echo ""
status_row "Update Upgrade" "ok"
sleep 0.8

status_row "Installing script" "instalado"
sleep 0.8

status_row "Creando directorios" "creado"
sleep 1

echo -e "\n\e[1;32m✔ Instalación completada correctamente\e[0m\n"

echo -e "Para ingresar al menú ejecute:\n"
echo -e "         \e[1;35;5mpanel\e[0m\n"
sleep 2
}

if [ ! -f /etc/reycode_intro_done ]; then
    run_intro
    touch /etc/reycode_intro_done
fi
